    ...
    function details(){
        ...
        $.ajax({
            ...
            success: function (responsedata) {
                document.getElementById('vision').value = responsedata.data.vision;
                document.getElementById('mission1').value = responsedata.data.mission1;
                document.getElementById('mission2').value = responsedata.data.mission2;
                document.getElementById('department_vision').value = responsedata.data.department_vision;
                document.getElementById('strategy').value = responsedata.data.strategy;
                document.getElementById('objectives').value = responsedata.data.objectives; 
            },
            error: function() { 
